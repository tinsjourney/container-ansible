...
ADD http://releases.ansible.com/ansible/ansible-2.2.0.0.tar.gz /opt/ansible/
RUN tar -xzf /opt/ansible/ansible-2.2.0.0.tar.gz --strip-components=1 -C /opt/ansible
